...
const parseCmd = () => {
  let options = {
    ...
    headerTemplate: '<div style="font-family: -apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Oxygen-Sans,Ubuntu,Cantarell,Helvetica Neue,sans-serif;font-size:8px!important;color:grey!important;padding-left:3em;" class="pdfheader"><span class="date"></span></div>',
    footerTemplate: '<div style="font-family: -apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Oxygen-Sans,Ubuntu,Cantarell,Helvetica Neue,sans-serif;font-size:8px!important;color:grey!important;padding-left:3em;" class="pdfheader"><span style="float: right;">Page: </span><span class="pageNumber"></span>/<span class="totalPages"></span>',
  };
